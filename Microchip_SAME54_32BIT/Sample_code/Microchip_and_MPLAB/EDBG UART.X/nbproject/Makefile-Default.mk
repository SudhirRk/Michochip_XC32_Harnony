...
# Source Files
SOURCEFILES=examples/driver_examples.c gcc/gcc/startup_same54.c gcc/system_same54.c hal/src/hal_atomic.c hal/src/hal_cache.c hal/src/hal_delay.c hal/src/hal_gpio.c hal/src/hal_init.c hal/src/hal_io.c hal/src/hal_sleep.c hal/src/hal_usart_async.c hal/utils/src/utils_assert.c hal/utils/src/utils_event.c hal/utils/src/utils_list.c hal/utils/src/utils_ringbuffer.c hal/utils/src/utils_syscalls.c hpl/cmcc/hpl_cmcc.c hpl/core/hpl_core_m4.c hpl/core/hpl_init.c hpl/dmac/hpl_dmac.c hpl/gclk/hpl_gclk.c hpl/mclk/hpl_mclk.c hpl/osc32kctrl/hpl_osc32kctrl.c hpl/oscctrl/hpl_oscctrl.c hpl/pm/hpl_pm.c hpl/ramecc/hpl_ramecc.c hpl/sercom/hpl_sercom.c edbg_uart_example.c driver_init.c atmel_start.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Default.mk dist/${CND_CONF}/${IMAGE_TYPE}/EDBG_UART.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/edbg_uart_example.o: edbg_uart_example.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/edbg_uart_example.o.d 
	@${RM} ${OBJECTDIR}/edbg_uart_example.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m4 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "./." -I "hpl/gclk" -I "hpl/sercom" -I "hpl/port" -I "hpl/mclk" -I "hpl/osc32kctrl" -I "hpl/oscctrl" -I "hpl/core" -I "hpl/ramecc" -I "hpl/cmcc" -I "hpl/dmac" -I "examples" -I "hal/utils/include" -I "hal/include" -I "hpl/pm" -I "config" -I "hri"  -I "include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/edbg_uart_example.o.d" -o ${OBJECTDIR}/edbg_uart_example.o edbg_uart_example.c  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
	@${FIXDEPS} "${OBJECTDIR}/edbg_uart_example.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  
