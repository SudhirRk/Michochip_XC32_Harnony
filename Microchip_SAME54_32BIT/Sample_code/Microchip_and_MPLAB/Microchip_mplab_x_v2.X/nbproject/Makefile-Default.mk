...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
# Source Files
SOURCEFILES=examples/driver_examples.c gcc/gcc/startup_same54.c gcc/system_same54.c hal/src/hal_atomic.c hal/src/hal_cache.c hal/src/hal_delay.c hal/src/hal_gpio.c hal/src/hal_init.c hal/src/hal_io.c hal/src/hal_sleep.c hal/src/hal_timer.c hal/src/hal_usart_async.c hal/utils/src/utils_assert.c hal/utils/src/utils_event.c hal/utils/src/utils_list.c hal/utils/src/utils_ringbuffer.c hal/utils/src/utils_syscalls.c hpl/cmcc/hpl_cmcc.c hpl/core/hpl_core_m4.c hpl/core/hpl_init.c hpl/dmac/hpl_dmac.c hpl/gclk/hpl_gclk.c hpl/mclk/hpl_mclk.c hpl/osc32kctrl/hpl_osc32kctrl.c hpl/oscctrl/hpl_oscctrl.c hpl/pm/hpl_pm.c hpl/ramecc/hpl_ramecc.c hpl/rtc/hpl_rtc.c hpl/sercom/hpl_sercom.c hpl/systick/hpl_systick.c main.c driver_init.c atmel_start.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/examples/driver_examples.o: examples/driver_examples.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m4 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "./." -I "hpl/gclk" -I "hpl/sercom" -I "hpl/port" -I "hpl/mclk" -I "hpl/osc32kctrl" -I "hpl/oscctrl" -I "hpl/systick" -I "hpl/core" -I "hpl/ramecc" -I "hpl/cmcc" -I "hpl/dmac" -I "examples" -I "hal/utils/include" -I "hal/include" -I "hpl/rtc" -I "hpl/pm" -I "config" -I "hri"  -I "include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/examples/driver_examples.o.d" -o ${OBJECTDIR}/examples/driver_examples.o examples/driver_examples.c  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/hal/src/hal_usart_async.o: hal/src/hal_usart_async.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/hal/src" 
	@${RM} ${OBJECTDIR}/hal/src/hal_usart_async.o.d 
	@${RM} ${OBJECTDIR}/hal/src/hal_usart_async.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m4 -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "./." -I "hpl/gclk" -I "hpl/sercom" -I "hpl/port" -I "hpl/mclk" -I "hpl/osc32kctrl" -I "hpl/oscctrl" -I "hpl/systick" -I "hpl/core" -I "hpl/ramecc" -I "hpl/cmcc" -I "hpl/dmac" -I "examples" -I "hal/utils/include" -I "hal/include" -I "hpl/rtc" -I "hpl/pm" -I "config" -I "hri"  -I "include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/hal/src/hal_usart_async.o.d" -o ${OBJECTDIR}/hal/src/hal_usart_async.o hal/src/hal_usart_async.c  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
	@${FIXDEPS} "${OBJECTDIR}/hal/src/hal_usart_async.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/hal/utils/src/utils_ringbuffer.o: hal/utils/src/utils_ringbuffer.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/hal/utils/src" 
	...
	@${FIXDEPS} "${OBJECTDIR}/hal/utils/src/utils_ringbuffer.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/examples/driver_examples.o: examples/driver_examples.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/examples/driver_examples.o.d 
	@${RM} ${OBJECTDIR}/examples/driver_examples.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m4  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "./." -I "hpl/gclk" -I "hpl/sercom" -I "hpl/port" -I "hpl/mclk" -I "hpl/osc32kctrl" -I "hpl/oscctrl" -I "hpl/systick" -I "hpl/core" -I "hpl/ramecc" -I "hpl/cmcc" -I "hpl/dmac" -I "examples" -I "hal/utils/include" -I "hal/include" -I "hpl/rtc" -I "hpl/pm" -I "config" -I "hri"  -I "include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/examples/driver_examples.o.d" -o ${OBJECTDIR}/examples/driver_examples.o examples/driver_examples.c  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
	@${FIXDEPS} "${OBJECTDIR}/examples/driver_examples.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=cortex-m4   -gdwarf-2  -D__$(MP_PROCESSOR_OPTION)__    -mthumb --specs=nosys.specs -Wl,-Map="dist\${CND_CONF}\${IMAGE_TYPE}\Microchip_mplab_x_v2.X.${IMAGE_TYPE}.map"  -o dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1  -L"gcc/gcc" -Wl,--gc-sections   -T"gcc/gcc/same54p20a_flash.ld" 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=cortex-m4  -D__$(MP_PROCESSOR_OPTION)__    -mthumb --specs=nosys.specs -Wl,-Map="dist\${CND_CONF}\${IMAGE_TYPE}\Microchip_mplab_x_v2.X.${IMAGE_TYPE}.map"  -o dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)  -L"gcc/gcc" -Wl,--gc-sections   -T"gcc/gcc/same54p20a_flash.ld" 
	
	${MP_CC_DIR}\\arm-none-eabi-objcopy -O ihex -R .eeprom -R .fuse -R .lock -R .signature "dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "dist/${CND_CONF}/${IMAGE_TYPE}/Microchip_mplab_x_v2.X.${IMAGE_TYPE}.hex"
