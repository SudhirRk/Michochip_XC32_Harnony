...
${OBJECTDIR}/_ext/2060180706/plib_sercom5_usart.o: ../src/config/sam_e54_xpro/peripheral/sercom/usart/plib_sercom5_usart.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/2060180706" 
	@${RM} ${OBJECTDIR}/_ext/2060180706/plib_sercom5_usart.o.d 
	@${RM} ${OBJECTDIR}/_ext/2060180706/plib_sercom5_usart.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -O1 -I"../src" -I"../src/config/sam_e54_xpro" -I"../src/packs/ATSAME54P20A_DFP" -I"../src/packs/CMSIS/" -I"../src/packs/CMSIS/CMSIS/Core/Include" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/2060180706/plib_sercom5_usart.o.d" -o ${OBJECTDIR}/_ext/2060180706/plib_sercom5_usart.o ../src/config/sam_e54_xpro/peripheral/sercom/usart/plib_sercom5_usart.c    -DXPRJ_sam_e54_xpro=$(CND_CONF)    $(COMPARISON_BUILD)  -Wformat=2 -Werror-implicit-function-declaration -Wfloat-equal -Wundef -Wshadow -Wpointer-arith -Wbad-function-cast -Wwrite-strings -Waggregate-return -Wstrict-prototypes -Wmissing-format-attribute -Wno-deprecated-declarations -Wpacked -Wredundant-decls -Wnested-externs -Winline -Wlong-long -Wunreachable-code -Wmissing-noreturn -mdfp="${DFP_DIR}" ${PACK_COMMON_OPTIONS} 
	@${FIXDEPS} "${OBJECTDIR}/_ext/2060180706/plib_sercom5_usart.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
